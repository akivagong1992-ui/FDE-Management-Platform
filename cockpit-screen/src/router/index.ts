...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'knowledge', component: () => import('@/views/knowledge/Knowledge.vue'), meta: { title: '技术沉淀视图', n: 5 } },
      { path: 'capability', component: () => import('@/views/capability/Capability.vue'), meta: { title: '团队能力视图', n: 6 } },
    ],
  },
]
